...
if(!isset($_SESSION['username']))
    ...
    if (isset($_POST['username'])) {
        ...
        if (count($errors) == 0) {
            ...
            $sql = "UPDATE user SET password = '".$password."' WHERE user_id = '".$_SESSION['id']."'";
		...
		<div class="container">
			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					<form action="changepassword.php" class="form-horizontal" name="signup" method="post">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="password" class="form-control" placeholder="Type your new password..." value="" name="password">
										<span class="input-group-addon">
